...
template <>
TACHYON_EXPORT bool IcicleMMCS<math::BabyBear>::DoCommit(
    std::vector<math::RowMajorMatrix<math::BabyBear>>&& matrices,
    std::vector<std::vector<std::vector<math::BabyBear>>>&& outputs,
    void* icicle_poseidon2);

template <>
TACHYON_EXPORT bool IcicleMMCS<math::bls12_381::Fr>::DoCommit(
    std::vector<math::RowMajorMatrix<math::bls12_381::Fr>>&& matrices,
    std::vector<std::vector<std::vector<math::bls12_381::Fr>>>&& outputs,
    void* icicle_poseidon2);
